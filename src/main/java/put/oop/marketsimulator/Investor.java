...
public class Investor extends User{
    ...
    /**
     * Generates fields of Investor
     * @param synch
     * @param wrld
     */
    public Investor(Object synch,World wrld) {
        super(synch,wrld);
        Random rd=new Random();
        wallet=new Wallet((float)100+rd.nextFloat()*100000);
        investor_id = String.valueOf(100000+rd.nextInt(900000-1));
    }

    /**
     * 
     * @return Extended description of Investor
     */
    @Override
    public String longString() {
        return "Investor " + super.longString() + "\nwallet:\n" + wallet.longString();
    }

    /**
     * 
     * @return Short description of Investor
     */
    @Override
    public String toString() {
        DecimalFormat df = new DecimalFormat();
        df.setMaximumFractionDigits(2);
        return "Investor " + super.getLast_name() + ": " + df.format(wallet.getDolla());
    }
